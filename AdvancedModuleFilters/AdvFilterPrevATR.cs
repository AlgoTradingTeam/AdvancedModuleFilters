...
// Type: TSLab.AdvancedModuleFilters.AdvFilterPrevATR
...
namespace TSLab.AdvancedModuleFilters
{
  ...
  [HandlerName("Filter PrevATR")]
  [Input(0, TemplateTypes.SECURITY, Name = "Источник")]
  [Description("Значение индикатора ATR больше или меньше значения индикатора предыдущего ATR.")]
  public class AdvFilterPrevATR : IBar2BoolsHandler, IOneSourceHandler, IBooleanReturns, IStreamHandler, IHandler, ISecurityInputs, IContextUses
  {
    [HandlerParameter(Default = "true", IsShown = false, Name = "ATR > ATR[-i]", NotOptimized = true)]
